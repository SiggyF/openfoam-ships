# OpenFOAM Solver Container Analysis

**Base Image**: `opencfd/openfoam-default:latest` (e.g. v2512, v2506)
...
## OpenFOAM Usage
- **Installation Directory**: `/usr/lib/openfoam/openfoam2512` (Version dependent)
- **Environment Script**: `/usr/lib/openfoam/openfoam2512/etc/bashrc`
- **Tutorials Directory**: `/usr/lib/openfoam/openfoam2512/tutorials`
...
docker run --rm -u 0 -v $(pwd):/job -w /job opencfd/openfoam-default:latest \
    /bin/bash -c "source /usr/lib/openfoam/openfoam2512/etc/bashrc && ./Allrun"
```
